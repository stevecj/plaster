...
describe Plaster do
  ...
  describe "#deconstruct" do
    ...
    it "returns a hash with indifferent access for a flat hash" do
    ...
    it "returns a hash with indifferent access for a flat struct" do
    ...
    it "returns a hash with indifferent access for a flat Virtus model" do
